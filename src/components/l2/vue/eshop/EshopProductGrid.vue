...
<template>
  ...
  <!-- ── Checkout ────────────────────────────────────────── -->
  <div v-else-if="view === 'checkout'" data-component="eshop-checkout" class="vm-checkout">
  ...
  <!-- ── Cart ───────────────────────────────────────────── -->
  <div v-else-if="view === 'cart'" data-component="eshop-cart" class="vm-cart">
  ...
  <!-- ── Product detail ─────────────────────────────────── -->
  <div v-else-if="view === 'detail' && product" data-component="eshop-product-detail" :data-sku="product.sku" class="vm-detail">
