...
<template>
  ...
  <div v-else data-component="news-weather-widget" data-framework="vue">

    <!-- Breaking News -->
    <div v-if="breaking.length > 0" class="hn-wx-box hn-wx-breaking-box">
    ...
    <div class="hn-wx-box">
      ...
      <table class="hn-wx-table">
        ...
        <tbody>
          <tr v-for="z in _zones" :key="z.zone" class="hn-wx-row">
      ...
      <div class="hn-wx-metrics">
        ...
        <div v-for="a in _advisories" :key="a" class="hn-wx-advisory">⚠ {{ a }}</div>
