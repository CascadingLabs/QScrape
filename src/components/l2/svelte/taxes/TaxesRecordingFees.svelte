...
{:else}
  <div data-component="taxes-recording-fees" data-framework="svelte" class="er-fees">
    ...
    <div class="er-section">
      ...
      <div class="er-table-wrap">
        <table class="er-table">
          ...
          <tbody>
            {#each stdFees as f, i (f.index)}
              <tr data-index-type={f.index} class={i % 2 === 0 ? 'er-row' : 'er-row er-row-alt'}>
    ...
    <div class="er-section">
      ...
      <div class="er-table-wrap">
        <table class="er-table">
          ...
          <tbody>
            {#each transferTax as f, i (f.range)}
              <tr class={i % 2 === 0 ? 'er-row' : 'er-row er-row-alt'}>
