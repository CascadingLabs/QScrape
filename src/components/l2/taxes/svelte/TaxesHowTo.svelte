...
{:else}
  <div data-component="taxes-how-to" data-framework="svelte" class="er-how-to">
    <p class="er-intro">
    ...
    <div class="er-table-wrap">
      <table class="er-table">
        ...
        <tbody>
          {#each guides as g, i (g.type)}
            <tr data-index-type={g.type} class={i % 2 === 0 ? 'er-row' : 'er-row er-row-alt'}>
